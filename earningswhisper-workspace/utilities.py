...
secretKey = "ee7f32878c1ea3cab35bbc4a6e363df1f9c9dcf5b8f22b4ea2763c41eb381ca2b0a41401aff4ed85"
accessKey = "486BD347B711BFE75FF2"
...
def update_timestamp_salt_sig(http_method, path, body):
    ...
    to_sign = (http_method, path, salt, str(
        timestamp), accessKey, secretKey, body)

    h = hmac.new(secretKey.encode('utf-8'),
...
def current_sig_headers(salt, timestamp, signature):
    sig_headers = {'access_key': accessKey,
                   'salt': salt,
